...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', '--agent',
                        choices=['network', 'heur_random', 'heur_sort', 'heur_weight'], default='network')
    ...
    avg_napfd = rl_learning.train(no_scenarios=args.no_scenarios, print_log=args.quiet,
